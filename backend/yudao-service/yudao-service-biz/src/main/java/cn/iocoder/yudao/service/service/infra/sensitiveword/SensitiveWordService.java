...
public interface SensitiveWordService {
     ...
     * @return 敏感词
     */
    SystemSensitiveWord getSensitiveWord(Long id);
     ...
     * @return 敏感词列表
     */
    List<SystemSensitiveWord> getSensitiveWordList();
     ...
     * @return 敏感词分页
     */
    PageResult<SensitiveWordRespVO> getSensitiveWordPage(SensitiveWordPageReqVO pageReqVO);
     ...
     * @return 敏感词列表
     */
    List<SystemSensitiveWord> getSensitiveWordList(SensitiveWordExportReqVO exportReqVO);
