...
public class NotifyMessageController {
    ...
    public CommonResult<NotifyMessageResp> getNotifyMessage(@RequestParam("id") Long id) {
        SystemNotifyMessage notifyMessage = notifyMessageService.getNotifyMessage(id);
    ...
    @PreAuthorize("@ss.hasPermission('system:notify-message:query')")
    public CommonResult<PageResult<NotifyMessageResp>> getNotifyMessagePage(@Valid NotifyMessagePageReqVO pageVO) {
        PageResult<NotifyMessageResp> pageResult = notifyMessageService.getNotifyMessagePage(pageVO);
    ...
    public CommonResult<PageResult<NotifyMessageResp>> getMyMyNotifyMessagePage(@Valid NotifyMessageMyPageReqVO pageVO) {
        PageResult<NotifyMessageResp> pageResult = notifyMessageService.getMyMyNotifyMessagePage(pageVO,
    ...
    public CommonResult<List<NotifyMessageResp>> getUnreadNotifyMessageList(
            @RequestParam(name = "size", defaultValue = "10") Integer size) {
        List<SystemNotifyMessage> list = notifyMessageService.getUnreadNotifyMessageList(
