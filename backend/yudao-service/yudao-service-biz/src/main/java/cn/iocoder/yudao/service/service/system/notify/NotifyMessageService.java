...
public interface NotifyMessageService {
     ...
     * @return 站内信分页
     */
    PageResult<NotifyMessageResp> getNotifyMessagePage(NotifyMessagePageReqVO pageReqVO);
     ...
     * @return 站内信分页
     */
    PageResult<NotifyMessageResp> getMyMyNotifyMessagePage(NotifyMessageMyPageReqVO pageReqVO, Long userId, Integer userType);
     ...
     * @return 站内信
     */
    SystemNotifyMessage getNotifyMessage(Long id);
     ...
     * @return 站内信列表
     */
    List<SystemNotifyMessage> getUnreadNotifyMessageList(Long userId, Integer userType, Integer size);
