...
public class NotifyTemplateController {
    ...
    public CommonResult<Long> createNotifyTemplate(@Valid @RequestBody NotifyTemplateCreateReq createReqVO) {
    ...
    public CommonResult<Boolean> updateNotifyTemplate(@Valid @RequestBody NotifyTemplateUpdateReq updateReqVO) {
    ...
    public CommonResult<NotifyTemplateResp> getNotifyTemplate(@RequestParam("id") Long id) {
        SystemNotifyTemplate notifyTemplate = notifyTemplateService.getNotifyTemplate(id);
    ...
    @PreAuthorize("@ss.hasPermission('system:notify-template:query')")
    public CommonResult<PageResult<NotifyTemplateResp>> getNotifyTemplatePage(@Valid NotifyTemplatePageReqVO pageVO) {
        return success((notifyTemplateService.getNotifyTemplatePage(pageVO)));
    }
