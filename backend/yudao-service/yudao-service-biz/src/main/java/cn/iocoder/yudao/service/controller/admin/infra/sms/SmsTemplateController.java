...
import cn.iocoder.yudao.service.service.infra.sms.SmsTemplateService;
...
@Tag(name = "管理后台 - 短信模板")
@RestController
@RequestMapping("/infra/sms-template")
public class SmsTemplateController {
    ...
    public CommonResult<SmsTemplateRespVO> getSmsTemplate(@RequestParam("id") Long id) {
        SystemSmsTemplate smsTemplate = smsTemplateService.getSmsTemplate(id);
    ...
    public CommonResult<PageResult<SmsTemplateRespVO>> getSmsTemplatePage(@Valid SmsTemplatePageReqVO pageVO) {
        return success(smsTemplateService.getSmsTemplatePage(pageVO));
    }
    ...
    public void exportSmsTemplateExcel(@Valid SmsTemplateExportReqVO exportReqVO,
        ...
        List<SystemSmsTemplate> list = smsTemplateService.getSmsTemplateList(exportReqVO);
        // 导出 Excel
