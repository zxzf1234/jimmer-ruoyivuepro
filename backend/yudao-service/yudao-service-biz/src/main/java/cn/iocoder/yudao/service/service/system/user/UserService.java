...
public interface UserService {
     ...
     * @return 用户编号
     */
    Long createUser(@Valid UserCreateReq reqVO);
     ...
     * @param reqVO 用户信息
     */
    void updateUser(@Valid UserUpdateReq reqVO);
     ...
     * @return 分页列表
     */
    Page<SystemUser> getUserPage(UserPageReqVO reqVO);
     ...
     * @return 用户数组
     */
    List<UserExcelVO> getExportUserList(UserExportReqVO reqVO);
     ...
     * @return 用户 Map
     */
    default Map<Long, SystemUser> getUserMap(Collection<Long> ids) {
        if (CollUtil.isEmpty(ids)) {
            return new HashMap<>();
        }
        return CollectionUtils.convertMap(getUserList(ids), SystemUser::id);
    }
     ...
     * @return 用户们
     */
    List<SystemUser> getUserListByStatus(Integer status);
