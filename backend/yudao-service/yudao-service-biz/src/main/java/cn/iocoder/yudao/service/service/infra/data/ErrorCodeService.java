...
public interface ErrorCodeService {
     ...
     * @return 错误码
     */
    SystemErrorCode getErrorCode(Long id);
     ...
     * @return 错误码分页
     */
    PageResult<ErrorCodeRespVO> getErrorCodePage(ErrorCodePageReqVO pageReqVO);
     ...
     * @return 错误码列表
     */
    List<SystemErrorCode> getErrorCodeList(ErrorCodeExportReqVO exportReqVO);
