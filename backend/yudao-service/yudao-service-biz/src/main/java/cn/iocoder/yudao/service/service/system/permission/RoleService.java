...
public interface RoleService {
     ...
     * @return 角色列表
     */
    List<SystemRole> getRoleListByStatus(@Nullable Collection<Integer> statuses);
     ...
     * @return 是否有管理员
     */
    boolean hasAnySuperAdmin(Collection<SystemRole> roleList);
     ...
     * @return 是否有管理员
     */
    default boolean hasAnySuperAdmin(List<Long> ids) {
        return hasAnySuperAdmin(getRoleListFrom(ids));
    }
     ...
     * @return 角色分页结果
     */
    PageResult<SystemRole> getRolePage(RolePageReqVO reqVO);
     ...
     * @return 角色列表
     */
    List<SystemRole> getRoleList(RoleExportReqVO reqVO);
